...
public class MainActivity extends AppCompatActivity {
    ...
    private void getData() {
        ...
        String url = MyConfig.GET_DATA_URL;
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            JSONArray result = jsonObj.getJSONArray(MyConfig.JSON_ARRAY);
            for(int i=0;i<result.length();i++) {
                JSONObject jsonObject = result.getJSONObject(i);
                DataObject dataObject = new DataObject();

                dataObject.setNAME(jsonObject.getString(MyConfig.NAME_KEY));
                dataObject.setLOCATION(jsonObject.getString(MyConfig.LOCATION_KEY));
                dataObject.setADDRESS(jsonObject.getString(MyConfig.ADDRESS_KEY));
                dataObject.setCITY(jsonObject.getString(MyConfig.CITY_KEY));
                dataObject.setHOURLY_RATE(jsonObject.getString(MyConfig.HOURLY_RATE_KEY));
