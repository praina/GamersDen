...
public class AddDetailActivity extends AppCompatActivity {
    ...
    private void addData(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, MyConfig.ADD_DATA_URL,
...
//                        startActivity(intent);
            ...
            protected Map<String,String> getParams(){
                ...
                params.put(MyConfig.NAME_KEY,cafeNameET.getText().toString().trim());
                params.put(MyConfig.ADDRESS_KEY,cafeAddressET.getText().toString().trim());
                params.put(MyConfig.LOCATION_KEY,cafeLocationET.getText().toString().trim());
                params.put(MyConfig.CITY_KEY,cafeCityET.getText().toString().trim());
                params.put(MyConfig.HOURLY_RATE_KEY,cafeHourlyRateET.getText().toString().trim());
                return params;
            }
